...
plotGUSHcorr
```
As expected, GUSH price data tracks with that of VLO.
...
Okay, a correlation of -0.59 is much more correlative than VLO. The mildy strong negative correlation indicates that as stock price decrease, trading volume increases. 
...
Similar to GUSH, DRIP volume and price correlation is a mildy strong negative correlation of -0.45, indicating that once again, as ETF price decreases, volume increases. 
